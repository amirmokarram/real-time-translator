...
**Git:** repo on `main`. Commits: `ba00580` (initial, Phases 1–4a) → `8a6af5a` (history export). `.gitattributes` normalizes LF; `dist-electron`/`release` gitignored. **No remote yet** — offer to create via `gh` when user wants to push.
