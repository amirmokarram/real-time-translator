...
- **Build what he literally asked for, not the well-known pattern that resembles it.** He asked that the assist panel not move the scroll "when appending anything" (2026-07-23); I shipped the conventional stick-to-bottom (follow while at the bottom, hold still once scrolled up) and he came back with "It seems is not working" — he sits at the bottom by default, so from where he stood nothing had changed. His wording was already precise; the industry-standard behaviour was my own addition. **When his phrasing is absolute ("should not change", "never", "always"), take it at face value before reaching for the familiar UX pattern.**
